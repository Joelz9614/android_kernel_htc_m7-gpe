...
static void __init m7wlv_reserve(void)
{
	if (mem_size_mb == 64)
		return;
...
static void __init m7wlv_early_reserve(void)
{
...
static int m7wlv_usb_product_id_match_array[] = {
	0x0ff8, 0x0e4F, 
	0x0fa4, 0x0ea3, 
	0x0fa5, 0x0ea4, 
	0x0f29, 0x07ac, 
...
static int m7wlv_usb_product_id_rndis[] = {
	0x0748, 
	0x074e, 
	0x0749, 
	0x074f, 
...
static int m7wlv_usb_product_id_match(int product_id, int intrsharing)
{
        int *pid_array = m7wlv_usb_product_id_match_array;
        int *rndis_array = m7wlv_usb_product_id_rndis;
	int category = 0;
...
static struct android_usb_platform_data android_usb_pdata = {
	...
	.match = m7wlv_usb_product_id_match,
	.nluns		= 1,
	.vzw_unmount_cdrom = 1,
};
...
static void __init m7wlv_map_io(void)
{
...
static void __init m7wlv_init_irq(void)
{
...
static void __init m7wlv_allocate_memory_regions(void)
{
	m7wl_allocate_fb_region();
}

static void __init m7wlv_cdp_init(void)
{
...
static void __init m7wlv_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
	...
	printk(KERN_INFO "M7WLV_fixup:skuid=0x%x\n", skuid);
}


MACHINE_START(M7_WLV, "UNKNOWN")
	.fixup = m7wlv_fixup,
	.map_io = m7wlv_map_io,
	.reserve = m7wlv_reserve,
	.init_irq = m7wlv_init_irq,
	.handle_irq = gic_handle_irq,
	.timer = &msm_timer,
	.init_machine = m7wlv_cdp_init,
	.init_early = m7wlv_allocate_memory_regions,
	.init_very_early = m7wlv_early_reserve,
	.restart = msm_restart,
MACHINE_END
